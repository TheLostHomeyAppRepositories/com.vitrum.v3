...
class Vitrum6TriacDevice extends ZwaveDevice {
	/**
	...
	async onNodeInit() {
		...
		this.log('Vitrum 6 Triac has been initialized');
	}
	...
	async onAdded() {
		...
		this.log('Vitrum 6 Triac has been added');
	}
	...
	async vitrumSceneRunListener(args, state) {
		...
		this.log('Vitrum 6 Triac scene triggered');
	...
	// 	this.log('Vitrum 6 Triac MLS triggered');
	// 	if (
...
module.exports = Vitrum6TriacDevice;
